...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument("dwell_s", default_value="3", description="minimum dwell per candidate in seconds"),
        DeclareLaunchArgument("dwell_min_frames", default_value="3", description="perception frames a dwell must see"),
        DeclareLaunchArgument("verify_speed", default_value="0",
                              description="horizontal speed limit for the hops in m/s, 0 keeps the survey limit"),
        DeclareLaunchArgument("verify_acc", default_value="0",
                              description="horizontal acceleration limit for the hops, 0 keeps the survey limit"),
